...
const vendorRemediation = {
  ...
  "Cisco Secure Access": "Cisco Secure Access (SSE/ZTNA) and GSA target the same traffic flows and cannot run simultaneously. Coordinate with your Cisco and Microsoft administrators to designate one ZTNA client per device, or configure Cisco Secure Access split-tunneling to fully exclude Microsoft Entra ID and private access destinations.",
