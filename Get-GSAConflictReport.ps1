...
$KnownVendors = @(
    ...
    @{ Name="Symantec/Broadcom";Risk="Medium";Drivers=@("symnets","srtspx","SymEvent","BFE");              Services=@("SepMasterService","SymNetDrv");             Desc="Symantec Endpoint Protection network driver may conflict depending on policy configuration." }
