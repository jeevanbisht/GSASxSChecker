...
| Capability | Details |
|---|---|
| **14 vendor signatures** | Forcepoint, Check Point, Skyhigh, Zscaler, Netskope, Palo Alto, CrowdStrike, SentinelOne, Symantec, Cisco AnyConnect, iboss, Trellix, OpenVPN, WireGuard |
...
3. Vendor signature matching   →  14 curated vendor patterns
