...
| Capability | Details |
|---|---|
| **12+ vendor signatures** | Forcepoint, Check Point, Skyhigh, Zscaler, Netskope, Palo Alto, CrowdStrike, SentinelOne, Symantec, Trend Micro, Cisco, Sophos |
...
3. Vendor signature matching   →  12 curated vendor patterns
