...
| Capability | Details |
|---|---|
| **15 vendor signatures** | Forcepoint, Check Point, Skyhigh, Zscaler, Netskope, Palo Alto, CrowdStrike, SentinelOne, Symantec, Cisco AnyConnect, iboss, Trellix, OpenVPN, WireGuard, Cloudflare One |
...
3. Vendor signature matching   →  15 curated vendor patterns
